...
#define BOOT_CPU_XTAL_SPEED_KHZ (25000000)
/** \brief Desired system speed. */
#define BOOT_CPU_SYSTEM_SPEED_KHZ (80000000)
...
#define BOOT_COM_CAN_TX_MSG_ID (0x1E + 2 * get_board_id())
/** \brief Configure number of bytes in the target->host CAN message. */
#define BOOT_COM_CAN_TX_MAX_DATA (8)
/** \brief Configure CAN message ID host->target. */
#define BOOT_COM_CAN_RX_MSG_ID (0x1F + 2 * get_board_id())
 ...
 */
#define BOOT_FLASH_VECTOR_TABLE_CS_OFFSET (0x194)
